    ...
    <div>
      ...
      <div className="mb-2 ml-10">
        <div className="breadcrumbs text-sm md:px-36">
          <ul>
            ...
            <li>
              <a className="text-[12px]">Marques</a>
            </li>
            <li>
              <a className="text-[12px]">Valeria Collection</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="carousel w-full h-[80vh] relative mt-0">
        <div id="slide1" className="carousel-item relative w-full h-auto">
          ...
          <div className="absolute bottom-24 sm:bottom-32 left-1/2 transform -translate-x-1/2 md:top-10 md:left-10 md:translate-x-0 text-white z-10 text-center md:text-start">
            <h1 className="text-xl sm:text-xl md:text-4xl font-bold">
              Bienvenue chez Valeria Collection
            </h1>
            <p className="text-white text-start text-xs  md:text-lg mt-2">
              L’élégance exclusive, le luxe tout compris réinventé.
            </p>
          </div>
      ...
      <div className="md:mx-14">
        <section className="content-section md:items-center md:justify-center md:mr-14">
          <div className="flex flex-col lg:flex-row md:items-center md:justify-center">
            <div className="lg:w-full lg:mb-0 lg:pr-12 px-6 md:px-12 lg:px-16 xl:px-32 py-8 lg:py-16">
              <h1
                className="text-2xl md:text-3xl lg:text-5xl font-800 mb-6 lg:mb-10 text-start"
                style={{ color: "#281A2A" }}
              >
                Une retraite haut de gamme, pensée pour vous
              </h1>
              <div className="flex my-2">
                <div
                  className="w-1 h-[210px] lg:h-20"
                  style={{ backgroundColor: "#281A2A" }}
                ></div>
                <p
                  className="text-base md:text-lg lg:text-lg  font-600 text-start ml-6 lg:ml-10 my-2 mx-2 lg:mx-4"
                  style={{ color: "#281A2A" }}
                >
                  Valeria Collection vous invite à vivre une expérience où luxe, bien-être et immersion culturelle se rencontrent. Nos hôtels all-inclusive sont conçus pour offrir un équilibre parfait entre détente, raffinement et découverte, dans un cadre élégant et apaisant.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="content-section md:items-center md:justify-center md:mr-14 my-2">
          <div className="flex flex-col lg:flex-row md:items-center md:justify-center">
            <div className="lg:w-full lg:mb-0 lg:pr-12 px-6 md:px-12 lg:px-16 xl:px-32">
              <h1
                className="text-2xl md:text-3xl lg:text-5xl font-700 mb-6 lg:mb-10 text-center md:text-start"
                style={{ color: "#281A2A" }}
              >
                Pourquoi choisir Valeria Collection ?
              </h1>
              <div className="my-2">
                <p
                  className="text-base md:text-lg lg:text-lg mb-6 font-medium text-center md:text-start  my-2 lg:mx-4"
                  style={{ color: "#281A2A" }}
                >
                  - Un cadre intime et raffiné pour les couples en quête d’exclusivité et de sérénité.
                </p>
                <p
                  className="text-base md:text-lg lg:text-lg mb-6 font-medium text-center md:text-start  my-2 lg:mx-4"
                  style={{ color: "#281A2A" }}
                >
                  - Un environnement haut de gamme et sécurisé pour les familles désireuses de créer des souvenirs inoubliables.
                </p>
                <p
                  className="text-base md:text-lg lg:text-lg  font-medium text-center md:text-start  my-2 lg:mx-4"
                  style={{ color: "#281A2A" }}
                >
                  - Une immersion culturelle et bien-être sur-mesure pour les voyageurs exigeants à la recherche d’authenticité.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="content-section my-20">
          <div className="flex flex-col md:flex-row items-start w-full md:px-32">
            <div className="md:w-full text-center md:text-left mb-8 md:mb-0 md:mr-16">
              <h2 className="text-[#281A2A] text-4xl font-600 mb-10">
              Nos hôtels, l'excellence du confort et du bien-être
              </h2>
              <p className="text-gray-700 text-sm md:text-xl leading-relaxed">
                - 200 chambres élégantes et personnalisables, au standard 4,5 étoiles.
              </p>
              <p className="text-gray-700 text-sm md:text-xl leading-relaxed">
                - <b>Espaces dédiés au bien-être et à la remise en forme :</b> spas, padel, indoor cycling.
              </p>
              <p className="text-gray-700 text-sm md:text-xl leading-relaxed">
                - <b>Une offre all-inclusive premium :</b> cuisine gastronomique, expériences culturelles et activités sportives.
              </p>
            </div>

            <div className="md:w-full md:text-left">
              <h2 className="text-[#281A2A] text-4xl font-600 mb-10">
              L’expérience Valeria Collection
              </h2>
              <p className="text-gray-700 text-sm md:text-xl leading-relaxed">
                - <b>Saveurs & gastronomie :</b> Une gastronomie raffinée, axée sur la santé et les plaisirs gustatifs.
              </p>
              <p className="text-gray-700 text-sm md:text-xl leading-relaxed">
                - <b>Équilibre & relaxation :</b> Spas exclusifs, soins personnalisés et activités bien-être.
              </p>
              <p className="text-gray-700 text-sm md:text-xl leading-relaxed">
                - <b>Exploration & culture :</b> Expériences immersives, ateliers artisanaux et traditions locales.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="content-section items-center justify-center">
          <div className="flex flex-col md:flex-row items-center justify-center w-full px-16 md:px-36">
            <div className="md:w-full  items-center justify-center">
              <h2 className="text-[#281A2A] text-xl md:text-5xl md:font-500 font-700">
              Plongez dans l’univers Valeria Collection et vivez un séjour d’exception.
              </h2>
            </div>
          </div>
        </section>
        ...
        <section className="content-section items-center justify-center mt-16">
          <div className="flex flex-col md:flex-row items-center justify-center w-full px-16 md:px-36">
            <div className="md:w-full  items-center justify-center">
              <h2 className="text-[#281A2A] text-xl md:text-6xl font-500 ">
                Discover More
              </h2>
            </div>
          </div>
          <section
            className="relative lg:w-full h-1/2 px-6 md:px-16 lg:px-16 xl:px-16 py-8 lg:py-16"
          ...
          >
            ...
            >
              <source
                src="https://s3.eu-west-1.amazonaws.com/fractalitetest/2025-02-24T13:08:55.260270708_palmiya.mp4"
                type="video/mp4"
              />
