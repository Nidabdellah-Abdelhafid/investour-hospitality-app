...
function Home() {
  ...
  <div id="slide1" className="carousel-item relative w-full h-screen">
    ...
    <div className="absolute bottom-32 left-1/2 transform -translate-x-1/2 md:bottom-20 md:left-10 md:translate-x-0 text-white z-10 text-center md:text-start">
      <h1 className="text-2xl md:text-6xl font-700">OWN THE MOOD</h1>
      <p className="mt-2 text-sm md:text-lg">More Power Today, More Value Tomorrow</p>
    </div>

    {/* Carousel Controls Section */}
    <div className="absolute right-36 bottom-5 md:right-10 md:bottom-10 z-1 flex flex-col items-center space-y-2">
      ...
      <p className="text-white text-center text-xs md:text-sm mt-2">Royal Mansour Marrakech</p>
    </div>
  </div>
